...
import 'package:flutter_cvmaker/data/background_data.dart';
import 'package:flutter_cvmaker/models/award_model.dart';
import 'package:flutter_cvmaker/models/contact_model.dart';
import 'package:flutter_cvmaker/models/education_model.dart';
...
import 'package:flutter_cvmaker/view_model/award_view_model.dart';
import 'package:flutter_cvmaker/view_model/contact_view_model.dart';
import 'package:flutter_cvmaker/view_model/education_view_model.dart';
import 'package:flutter_cvmaker/view_model/languages_view_model.dart';
import 'package:flutter_cvmaker/view_model/profile_view_model.dart';
import 'package:flutter_cvmaker/view_model/skills_view_model.dart';
import 'package:flutter_cvmaker/view_model/works_view_model.dart';
...
class CVSecreen extends StatefulWidget {
  const CVSecreen();

  @override
  _CVSecreenState createState() => _CVSecreenState();
}

enum AppState { clear, picking, picked, cropped }

class _CVSecreenState extends State<CVSecreen> {
  ...
  List<List<String>> workListing = List.generate(
      3, (i) => List.filled(4, "", growable: false),
      growable: false);
  List<List<String>> educationListing = List.generate(
  ...
  List<List<dynamic>> skillListing = [['',0]];
  ...
  List<String> awardListing = List.filled(3, '', growable: false);
  ...
  ContactViewModel cviewModel = ContactViewModel();
  List<ContactModel> c = [];
  ProfileViewModel pviewModel = ProfileViewModel();
  List<ProfileModel> p = [];
  AwardViewModel aviewModel = AwardViewModel();
  List<AwardModel> a = [];
  EducationViewModel educationViewModel = EducationViewModel();
  List<EducationModel> e = [];
  SkillsViewModel skillsViewModel = SkillsViewModel();
  List<SkillsModel> s = [];
  WorksViewModel worksViewModel = WorksViewModel();
  List<WorkModel> work = [];
  LanguagesViewModel languagesViewModel = LanguagesViewModel();
  ...
  contactMrthod() async {
    try {
      c = await cviewModel
          .getContactByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      phoneInputController.text = c.first.phoneNo.toString();
      emailInputController.text = c.first.email.toString();
      addressInputController.text = c.first.address.toString();
      contactPhone = c.first.phoneNo.toString();
      contactEmail = c.first.email.toString();
      contactAddress = c.first.address.toString();
      setState(() {});
    } catch (e) {
      c = [ContactModel(id: "non")];
  ...
  void dialogContact(BuildContext context) async {
    contactMrthod();
    showDialog(
        context: context,
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            errorText: errorPhone, labelText: 'رقم الهاتف'),
                      ),
                      TextFormField(
                        controller: emailInputController,
                        maxLength: 30,
                        decoration: InputDecoration(
                            errorText: errorEmail, labelText: 'الايميل'),
                      ),
                      TextFormField(
                        ...
                        maxLength: 30,
                        decoration: InputDecoration(
                            errorText: errorAddress, labelText: 'العنوان'),
                      ),
                    ],
                  ),
                ),
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (phoneInputController.text.isEmpty) {
                        stfSetState(() {
                          errorPhone = 'يرجى ادخال رقم الهاتف';
                        });
                      } else if (emailInputController.text.isEmpty) {
                        stfSetState(() {
                          errorEmail = 'يرجى ادخال الايميل';
                        });
                      } else if (addressInputController.text.isEmpty) {
                        stfSetState(() {
                          errorAddress = 'يرجى ادخال العنوان';
                        });
                      } else {
                        setState(() {
                          ...
                          cviewModel.addContact(ContactModel(
                              phoneNo: phoneInputController.text,
                              id: c.first.id,
  ...
  profileMethod() async {
    try {
      p = await pviewModel
          .getProfileByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      birthdateInputController.text = p.first.infoBirthDate.toString();
      nationalityInputController.text = p.first.infoNationality.toString();
      firstnameInputController.text = p.first.firstName.toString();
      lastnameInputController.text = p.first.lastName.toString();
      positionInputController.text = p.first.positionName.toString();
      profileInputController.text = p.first.profileDetail.toString();

      infoBirthDate = p.first.infoBirthDate.toString();
      infoNationality = p.first.infoNationality.toString();
      firstName = p.first.firstName.toString();
      lastName = p.first.lastName.toString();
      positionName = p.first.positionName.toString();
      profileDetail = p.first.profileDetail.toString();
      setState(() {});
    } catch (e) {
      p = [ProfileModel(id: "non")];
      infoBirthDate = '';
      infoNationality = '';
      firstName = '';
      lastName = '';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        maxLength: 30,
                        decoration: InputDecoration(
                            errorText: errorPosition, labelText: 'المنصب'),
                      ),
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            labelText: 'الملف التعريفي '),
                      ),
                      TextFormField(
                        controller: birthdateInputController,
                        maxLength: 30,
                        decoration: InputDecoration(
                            errorText: errorBithdate,
                      ...
                      TextFormField(
                        ...
                        maxLength: 30,
                        decoration: InputDecoration(
                            errorText: errorNationality, labelText: 'الجنسية'),
                      ),
                    ],
                  ),
                ),
                    ...
                    onPressed: () {
                      ...
                      if (birthdateInputController.text.isEmpty) {
                        ...
                        setState(() {
                          ...
                          try {
                            pviewModel.addProfile(ProfileModel(
                                id: p.first.id.toString(),
                                firstName: firstnameInputController.text,
                                lastName: lastName,
  ...
  awardMethod() async {
    try {
      ...
      a.clear();
      a = await aviewModel
          .getAwardByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      a.forEach((element) {
        awardListing.add(element.name.toString());
      });
      print("hhhhhfgfff${a.length}");
      if (a.isNotEmpty) {
        award1InputController.text = a[0].name.toString();
        awardListing[0] = a[0].name.toString();
      }
      if (a.length > 1) {
        award2InputController.text = a[1].name.toString();
        awardListing[1] = a[1].name.toString();
      }
      if (a.length > 2) {
        award3InputController.text = a[2].name.toString();
        awardListing[2] = a[2].name.toString();
      }
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'جائزة 1'),
                    ),
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'جائزة 2'),
                    ),
                    TextFormField(
                      ...
                      minLines: 3,
                      maxLines: 3,
                      decoration: const InputDecoration(labelText: 'جائزة 3'),
                    ),
                  ],
                ),
              ),
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      ...
                      for (int i = 0; i < awardListing.length; i++) {
                        aviewModel.addAward(AwardModel(
                            id: a[i].id == "" ? "non" : a[i].id,
                            name: awardListing[i],
                            userID: SpHelper.spHelper.getMyID().toString()));
                      }
                      // awardListing.forEach((element) {
                      //   aviewModel.addAward(AwardModel(
                      //     id: a.first.id,
                      //       name: element,
                      //       userID: SpHelper.spHelper.getMyID().toString()));
  ...
  educationMethod() async {
    try {
      e = await educationViewModel
          .getEducationsByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      print("eeeeeeeeeeeeeeee${e.length}");

      if (e.isNotEmpty) {
        edu1YearInputController.text = e[0].year.toString();
        educationListing[0][0] = e[0].year.toString();
        edu1MajorInputController.text = e[0].major.toString();
        educationListing[0][1] = e[0].major.toString();
        edu1YearInputController.text = e[0].year.toString();
        educationListing[0][2] = e[0].year.toString();
      }
      if (e.length > 1) {
        edu2YearInputController.text = e[1].year.toString();
        educationListing[1][0] = e[1].year.toString();
        edu2MajorInputController.text = e[1].major.toString();
        educationListing[1][1] = e[1].major.toString();
        edu2YearInputController.text = e[1].year.toString();
        educationListing[1][2] = e[1].year.toString();
      }
      if (e.length > 2) {
        edu3YearInputController.text = e[2].year.toString();
        educationListing[2][0] = e[2].year.toString();
        edu3MajorInputController.text = e[0].major.toString();
        educationListing[2][1] = e[2].major.toString();
        edu3YearInputController.text = e[0].year.toString();
        educationListing[2][2] = e[2].year.toString();
      }
      print("mfdfdf $educationListing");
      setState(() {});

      if (e.isEmpty) {
        e = [EducationModel(id: "non")];
        educationListing.clear();
        setState(() {});
      }
    } catch (ex) {
      print("gggggggggggggggggg$ex");
      e = [EducationModel(id: "non")];
      educationListing.clear();
      setState(() {});
    }
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'السنة', errorText: errorEdu1Year),
                          ),
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'التخصص', errorText: errorEdu1Major),
                          ),
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'الجهه', errorText: errorEdu1School),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'الجهه'),
                          ),
                        ],
                      ),
                    ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (edu1YearInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1Year = 'الرجاء ادخل السنة';
                      });
                    } else if (edu1MajorInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1Major = 'الرجاء ادخال التخصص';
                      });
                    } else if (edu1SchoolInputController.text.isEmpty) {
                      stfSetState(() {
                        errorEdu1School = 'الرجاء ادخال الجهه';
                      });
                    } else {
                      setState(() {
                        educationListing = [];
                        ...
                        for (int i = 0; i < educationListing.length; i++) {
                          educationViewModel.addEducation(EducationModel(
                              id: a[i].id == "" ? "non" : a[i].id,
                              year: educationListing[i][0],
                              major: educationListing[i][1],
                              institute: educationListing[i][2],
                              userID: SpHelper.spHelper.getMyID().toString()));
                        }
                        edu1YearInputController.text = '';
                        edu1MajorInputController.text = '';
  ...
  worksMethod() async {
    try {
      work = await worksViewModel
          .getWorksByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      print(work);

      if (work.isNotEmpty) {
        work1YearInputController.text = work[0].year.toString();
        workListing[0][0] = work[0].year.toString();
        work1PositionInputController.text = work[0].position.toString();
        workListing[0][1] = work[0].position.toString();
        work1CompanyInputController.text = work[0].company.toString();
        workListing[0][2] = work[0].company.toString();
        work1DetailInputController.text = work[0].detail.toString();
        workListing[0][3] = work[0].detail.toString();
      }
      if (work.length > 1) {
        work2YearInputController.text = work[1].year.toString();
        workListing[1][0] = work[1].year.toString();
        work2PositionInputController.text = work[1].position.toString();
        workListing[1][1] = work[1].position.toString();
        work2CompanyInputController.text = work[1].company.toString();
        workListing[1][2] = work[1].company.toString();
        work2DetailInputController.text = work[1].detail.toString();
        workListing[1][3] = work[1].detail.toString();
      }
      if (work.length > 2) {
        work3YearInputController.text = work[2].year.toString();
        workListing[2][0] = work[2].year.toString();
        work3PositionInputController.text = work[1].position.toString();
        workListing[2][1] = work[2].position.toString();
        work3CompanyInputController.text = work[1].company.toString();
        workListing[2][2] = work[2].company.toString();
        work3DetailInputController.text = work[1].detail.toString();
        workListing[1][3] = work[2].detail.toString();
      }
      setState(() {});

      if (work.isEmpty) {
        work = [WorkModel(id: "non")];
        workListing.clear();
        setState(() {});
      }
    } catch (ex) {
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration: InputDecoration(
                                labelText: 'السنة', errorText: errorWork1Year),
                          ),
                          TextFormField(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'المنصب'),
                          ),
                          TextFormField(
                            ...
                            maxLines: 1,
                            decoration:
                                const InputDecoration(labelText: 'الشركة'),
                          ),
                          TextFormField(
                  ...
                  onPressed: () {
                    ...
                    if (work1YearInputController.text.isEmpty) {
                      ...
                      setState(() {
                        ...
                        for (int i = 0; i < workListing.length; i++) {
                          worksViewModel.addWork(WorkModel(
                              id: a[i].id == "" ? "non" : a[i].id,
                              year: workListing[i][0],
                              position: workListing[i][1],
                              company: workListing[i][2],
                              detail: workListing[i][3],
                              userID: SpHelper.spHelper.getMyID().toString()));
                        }
                        work1YearInputController.text = '';
                        work1PositionInputController.text = '';
  ...
  skillsMethod() async {
    try {
      s = await skillsViewModel
          .getSkillsByUserId(SpHelper.spHelper.getMyID().toString())
          .first;

      if (s.isNotEmpty) {
        skill1TitleInputController.text = s[0].title.toString();
        skillListing[0][0] = s[0].title;
        skill1ScoreInputController.text = s[0].score.toString();
        skillListing[0][1] = s[0].score;
      }
      if (s.length > 1) {
        skill2TitleInputController.text = s[1].title.toString();
        // skillListing[1][0] = s[1].title;
        skill2ScoreInputController.text = s[1].score.toString();
        // skillListing[1][1] = s[1].score;
        skillListing.add([s[1].title,s[1].score]);
      }
      if (s.length > 2) {
        skill2TitleInputController.text = s[2].title.toString();
        // skillListing[2][0] = s[2].title;
        skill2ScoreInputController.text = s[2].score.toString();
        // skillListing[2][1] = s[2].score;
                skillListing.add([s[2].title,s[2].score]);

      }
      if (s.length > 3) {
        skill3TitleInputController.text = s[3].title.toString();
        // skillListing[3][0] = s[3].title.toString();
        skill3ScoreInputController.text = s[3].score.toString();
        // skillListing[3][1] = s[3].score.toString();
                skillListing.add([s[3].title,s[3].score]);

      }
      if (s.length > 4) {
        skill4TitleInputController.text = s[4].title.toString();
        // skillListing[4][0] = s[4].title.toString();
        skill4ScoreInputController.text = s[4].score.toString();
        // skillListing[4][1] = s[4].score.toString();
          skillListing.add([s[4].title,s[4].score]);
      }
      if (s.length > 5) {
        skill5TitleInputController.text = s[5].title.toString();
        // skillListing[5][0] = s[5].title;
        skill5ScoreInputController.text = s[5].score.toString();
        // skillListing[5][1] = s[5].score;
        skillListing.add([s[5].title,s[5].score]);
      }
      if (s.length > 6) {
        skill6TitleInputController.text = s[6].title.toString();
        // skillListing[6][0] = s[6].title;
        skill6ScoreInputController.text = s[6].score.toString();
        // skillListing[6][1] = s[6].score;
        skillListing.add([s[6].title,s[6].score]);
      }

      setState(() {});

      if (s.isEmpty) {
        s = [SkillsModel(id: "non")];
        skillListing.clear();
        setState(() {});
      }
    } catch (ex) {
      print("bbbbbbbbbbbbbbbbbggggggggggg$ex");
      s = [SkillsModel(id: "non")];
      skillListing.clear();
      setState(() {});
    }
                  ...
                  onPressed: () {
                    ...
                    if (skill1TitleInputController.text.isEmpty) {
                      ...
                      setState(() {
                        ...
                        for (int i = 0; i <= skillListing.length; i++) {
                          skillsViewModel.addSkill(SkillsModel(
                              id: s[i].id == "" ? "non" : s[i].id,
                              title: skillListing[i][0],
                              score: int.parse(skillListing[i][1].toString()),
                              userID: SpHelper.spHelper.getMyID().toString()));
                        }
                        skill1TitleInputController.text = '';
                        skill1ScoreInputController.text = '';
  ...
  languagesMethod() async {
    try {
      languages = await languagesViewModel
          .getLanguageslByUserId(SpHelper.spHelper.getMyID().toString())
          .first;
      if (languages.isNotEmpty) {
        language1TitleInputController.text = languages[0].title.toString();
        languageListing[0][0] = languages[0].title.toString();
        language1ReadingInputController.text = languages[0].reading.toString();
        languageListing[0][1] = languages[0].reading;
        language1WritingInputController.text = languages[0].writing.toString();
        languageListing[0][2] = languages[0].writing;
        language1ListeningInputController.text =
            languages[0].listening.toString();
        languageListing[0][3] = languages[0].listening;
        language1SpeakingInputController.text =
            languages[0].speaking.toString();
        languageListing[0][4] = languages[0].speaking;
        
      }
      if (languages.length > 1) {
        language1TitleInputController.text = languages[1].title.toString();
        // languageListing[1][0] = languages[1].title.toString();
        language1ReadingInputController.text = languages[1].reading.toString();
        // languageListing[1][1] = languages[1].reading.toString();
        language1WritingInputController.text = languages[1].writing.toString();
        // languageListing[1][2] = languages[1].writing.toString();
        language1ListeningInputController.text =
            languages[1].listening.toString();
        // languageListing[1][3] = languages[1].listening.toString();
        language1SpeakingInputController.text =
            languages[1].speaking.toString();
        // languageListing[1][4] = languages[1].speaking.toString();
        languageListing.add([languages[1].title.toString(),languages[1].reading.toString(),languages[1].writing.toString(),languages[1].listening.toString(),languages[1].speaking.toString()]);
      }
      if (languages.length > 2) {
        language1TitleInputController.text = languages[2].title.toString();
        // languageListing[2][0] = languages[2].title.toString();
        language2ReadingInputController.text = languages[2].reading.toString();
        // languageListing[2][1] = languages[2].reading.toString();
        language1WritingInputController.text = languages[2].writing.toString();
        // languageListing[2][2] = languages[2].writing.toString();
        language1ListeningInputController.text =
            languages[2].listening.toString();
        // languageListing[2][3] = languages[2].listening.toString();
        language1SpeakingInputController.text =
            languages[2].speaking.toString();
        // languageListing[2][4] = languages[2].speaking.toString();
                languageListing.add([languages[2].title.toString(),languages[2].reading.toString(),languages[2].writing.toString(),languages[2].listening.toString(),languages[2].speaking.toString()]);

      }
      if (languages.length > 3) {
        language1TitleInputController.text = languages[3].title.toString();
        // languageListing[3][0] = languages[3].title.toString();
        language2ReadingInputController.text = languages[3].reading.toString();
        // languageListing[3][1] = languages[3].reading.toString();
        language1WritingInputController.text = languages[3].writing.toString();
        // languageListing[3][2] = languages[3].writing.toString();
        language1ListeningInputController.text =
            languages[3].listening.toString();
        // languageListing[3][3] = languages[3].listening.toString();
        language1SpeakingInputController.text =
            languages[3].speaking.toString();
        // languageListing[3][4] = languages[3].speaking.toString();
                languageListing.add([languages[3].title.toString(),languages[3].reading.toString(),languages[3].writing.toString(),languages[3].listening.toString(),languages[3].speaking.toString()]);

      }
      setState(() {});

      if (languages.isEmpty) {
        languages = [LanguagesModel(id: "non")];
        languageListing.clear();
        setState(() {});
      }
    } catch (ex) {
      languages = [LanguagesModel(id: "non")];
                              ...
                              Expanded(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                      labelText: 'القراءة', hintText: '1-3'),
                                  onChanged: (text) {
                                    if (int.parse(text) < 1 ||
                                        int.parse(text) > 3) {
                                ...
                                child: TextFormField(
                                  ...
                                  keyboardType:
                                      const TextInputType.numberWithOptions(
                                          decimal: true),
                                  decoration: const InputDecoration(
                                      labelText: 'الكتابة', hintText: '1-3'),
                                  onChanged: (text) {
                                    if (int.parse(text) < 1 ||
                                        int.parse(text) > 3) {
                  ...
                  onPressed: () {
                    ...
                    if (language1TitleInputController.text.isEmpty) {
                      ...
                      setState(() {
                        ...
                        for (int i = 0; i <= languageListing.length; i++) {
                          languagesViewModel.addLanguage(LanguagesModel(
                              id: s[i].id == "" ? "non" : s[i].id,
                              title: languageListing[i][0],
                              reading:
                                  int.parse(languageListing[i][1].toString()),
                              writing:
                                  int.parse(languageListing[i][2].toString()),
                              listening:
                                  int.parse(languageListing[i][3].toString()),
                              speaking:
                                  int.parse(languageListing[i][4].toString()),
                              userID: SpHelper.spHelper.getMyID().toString()));
                        }
                        language1TitleInputController.text = '';
                        language1ReadingInputController.text = '';
