...
class CVSecreenSearch extends StatefulWidget {
const CVSecreenSearch({required this.userID});
 final String userID;
...
class _CVSecreenState extends State<CVSecreenSearch> {
  ...
  contactMrthod() async {
    try {
      c = await cviewModel
          .getContactByUserId(widget.userID.toString())
          .first;
  ...
  profileMethod() async {
    try {
      p = await pviewModel
          .getProfileByUserId(widget.userID.toString())
          .first;
  ...
  awardMethod() async {
    try {
      ...
      a.clear();
      a = await aviewModel
          .getAwardByUserId(widget.userID.toString())
          .first;
      a.forEach((element) {
  ...
  educationMethod() async {
    try {
      e = await educationViewModel
          .getEducationsByUserId(widget.userID.toString())
          .first;
  ...
  worksMethod() async {
    try {
      work = await worksViewModel
          .getWorksByUserId(widget.userID.toString())
          .first;
      print(work);
  ...
  skillsMethod() async {
    try {
      s = await skillsViewModel
          .getSkillsByUserId(widget.userID.toString())
          .first;
  ...
  languagesMethod() async {
    try {
      languages = await languagesViewModel
          .getLanguageslByUserId(widget.userID.toString())
          .first;
