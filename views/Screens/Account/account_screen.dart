...
import 'package:flutter_cvmaker/views/Screens/CV/cv_screen.dart';
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  initState() {
    ...
    getMajors();
    getQualification();
    primaryPhoneNpController.text = widget.user.primaryPhoneNo.toString();
    userNameController.text = widget.user.name.toString();
    dropdownValue.name = widget.user.major;
    dropdownValueQ.name = widget.user.qualification;
    majorHint = widget.user.major.toString();
    qHint = widget.user.qualification.toString();
  }
              ...
              child: Column(
                children: [
                  ...
                  DropdownSearch<QualificationModel>(
                    ...
                    selectedItem:
                        QualificationModel(name: widget.user.qualification),
                    enabled: true,
                    items: qualification,
                  ...
                  DropdownSearch<MajorModel>(
                    ...
                    // selectedItem: MajorModel(name: widget.user.major),
                    enabled: true,
                    items: majors,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        .routingToSpecificWidgetWithoutPop(CVSecreen());
                        },
                        child: Container(
                          alignment: Alignment.center,
                          width: 120.w,
